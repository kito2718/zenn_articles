...
極端に偏った分布は、対数変換することで右側のような「正規分布」に近づけることができます。

![Fareの対数変換前後の分布](https://github.com/kito2718/zenn_articles/raw/main/articles/images/fare_log_transform.png)
...
![Ageの年齢層別ビン化と生存率](https://github.com/kito2718/zenn_articles/raw/main/articles/images/age_binning.png)
