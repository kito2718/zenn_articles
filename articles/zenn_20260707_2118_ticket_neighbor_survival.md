...
![エラー分析 (Pclass別の誤分類分布)](images/zenn_20260707_2118_error_analysis_pclass.png)*エラー分析(Pclass別の誤分類分布)*
-----------
...
![Ticket近接生存率 (OOF) の生存・死亡別分布](images/zenn_20260707_2118_ticket_neighbor_survival_dist.png)*Ticket近接生存率 (OOF) の生存・死亡別分布*
-----------
