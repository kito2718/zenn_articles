---
title: "ARCoreを使った画像認識ARアプリを公開してみた"
emoji: "🚢"
type: "tech"
topics:
  - "arcore"
...
`VideoPhotoBook` で使ってた Vuforiaライブラリ から Google 公式の ARCore にライブラリに変更したんだけど、事前準備が不要になったのは楽。
Vuforiaって事前準備として、マーカーをVuforiaのサイトで登録しとく必要があったんよね。それがめんどかった。
ARCoreでアプリだけで完結するのは相当に楽だった。
